...
1. **서버 변경분 반영 (`server-sync-todo.md`)** — T1~T9·T11 완료(T3의 핸들러 5개 전부 등록 완료), T10은 데이터 경로가 끝나고 **UI 프리팹 대기**, T12는 **런타임 실측만 남음**. 남은 것은 T15(귀환 후처리) → T16·T17. **T13은 시신 프리팹 제작 대기, T14는 서버 목록 대기**
