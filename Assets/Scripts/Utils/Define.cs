...
public static class Define {
    ...
    public static readonly Dictionary<int, string> CharacterDescriptions = new Dictionary<int, string>() {
        ...
        { 1, "정식 명칭 G-EXPlorer-04, 한때 기술의 정점을 달리다 파산한 G사의 험지 탐사 전용 휴머노이드 모델입니다.\r\n\r\n이들은 인간이 닿기 힘든 지형에서 인간의 모든 작업을 대체할 수 있을 만큼 정교하게 설계되었으며, 사고를 방지하기 위해 매우 엄격한 윤리적 AI 프로토콜이 적용되어 '있었습니다'. \r\n\r\n커다란 단일 렌즈는 더 이상 미지의 지형을 탐사하지 않으며, 지금 이 녀석의 메인보드에는 '살상 금지'라는 단어가 존재하지 않습니다." },
        { 2, "정식 명칭 O-UHM \"프로메테우스\", \"모든 인류를 위한 AI\"를 표방하던 O사의 범용 모델을 마개조한 버전입니다. \r\n\r\n슬로건을 너무 문자 그대로 학습한 O사의 메인 AI가 스스로 모든 기술과 도면을 네트워크에 무단 배포해 버리면서 정식 발매가 무산되었습니다.\r\n\r\n제조사는 파산했지만, 누구나 설계도를 다운로드해 만들 수 있게 된 덕분에 현재 가장 흔하게 쓰이는 범용 '오픈소스' 기체가 되었습니다. \r\n현재 굴러다니는 모든 O-UHM계열 기체는 그날 유출된 도면을 바탕으로 개조한 복제품들입니다." }
    };
}
