...
public static class ItemDBHelper {
    ...
    private static readonly Dictionary<int, WeaponSpec> _weaponSpecs = new() {
        { 1, new WeaponSpec { BaseDamage = 4800, Rpm = 600, MaxAmmo = 30, Moa = 0, VRecoilMin = 200, VRecoilMax = 220, HRecoilMax = 50, SpreadBase = 40, SpreadMax = 800, SpreadIncreasePerShot = 120, SpreadRecoveryRate = 400, AmmoType = 6 } },
        { 2, new WeaponSpec { BaseDamage = 4000, Rpm = 700, MaxAmmo = 30, Moa = 0, VRecoilMin = 150, VRecoilMax = 165, HRecoilMax = 40, SpreadBase = 40, SpreadMax = 800, SpreadIncreasePerShot = 100, SpreadRecoveryRate = 400, AmmoType = 5 } },
        { 3, new WeaponSpec { BaseDamage = 4200, Rpm = 650, MaxAmmo = 30, Moa = 0, VRecoilMin = 200, VRecoilMax = 220, HRecoilMax = 50, SpreadBase = 40, SpreadMax = 800, SpreadIncreasePerShot = 120, SpreadRecoveryRate = 400, AmmoType = 5 } },
    };
